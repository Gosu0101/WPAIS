...
- [x] 9. Monitor Controller 구현
  - [x] 9.1 Monitor DTO 정의
  ...
  - [x] 9.2 GET /api/projects/:projectId/dashboard 구현
    - 대시보드 데이터 조회 엔드포인트
    - MonitorService.getDashboardData 호출
    - _Requirements: 4.1.1, 4.1.3_

  - [x] 9.3 GET /api/projects/:projectId/buffer-status 구현
    - 버퍼 상태 조회 엔드포인트
    - _Requirements: 4.2.1_

  - [x] 9.4 GET /api/projects/:projectId/risk 구현
    - 리스크 분석 조회 엔드포인트
    - _Requirements: 4.3.1_

  - [x] 9.5 GET /api/projects/:projectId/velocity 구현
    - 속도 분석 조회 엔드포인트
    - 트렌드 기간 쿼리 파라미터 지원
    - _Requirements: 4.4.1, 4.4.2, 4.4.3_

  - [x] 9.6 GET /api/projects/:projectId/health 구현
    - 건강 점검 조회 엔드포인트
    - _Requirements: 4.6.1, 4.6.2, 4.6.3, 4.6.4_

  - [x] 9.7 GET /api/projects/:projectId/alerts 구현
    - 알림 히스토리 조회 엔드포인트
    - 날짜 범위 필터링
    - 페이지네이션 적용
    - _Requirements: 4.5.1, 4.5.2, 4.5.3, 4.5.4_

- [x] 10. Checkpoint - Monitor API 완료
...
- [x] 12. Final checkpoint - API Layer 완료
